...
export function PatientsTab() {
  ...
  const handleEditPatient = (formData: FormData) => {
    ...
    const updates = {
      ...
      rightPower: formData.get('rightPower') as string || undefined,
      leftPower: formData.get('leftPower') as string || undefined,
    };
  ...
  return (
    <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Manage patient records and prescription information</p>
        </div>
