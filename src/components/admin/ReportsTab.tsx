    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">View clinic performance and statistics</p>
        </div>
        <button className="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-lg font-medium flex items-center space-x-2 transition-colors">
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          ...
          <div className="space-y-3">
            {['eye-test', 'consultation', 'frame-selection'].map((purpose) => {
              const count = appointments.filter(apt => apt.purpose === purpose).length;
              ...
              return (
                <div key={purpose} className="flex items-center justify-between">
                  <span className="text-gray-700 capitalize">{purpose.replace('-', ' ')}</span>
                  <div className="flex items-center space-x-2">
                    <div className="w-24 bg-gray-200 rounded-full h-2">
                      <div 
